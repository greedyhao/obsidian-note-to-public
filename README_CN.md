...
1. 下载最新版本：[Releases](https://github.com/greedyhao/obsidian-note-to-public/releases)
...
2. 填写微信公众号的 **AppID** 和 **AppSecret**
   ...
   - **AppSecret 会加密存储在 Obsidian SecretStorage 中，可在 设置 → 安全 → 密钥存储 中管理**
3. 可选：设置默认作者名称
...
- 复杂的图表可能需要更长的处理时间
- 确保你的网络连接正常以便上传图片
- **注意**: 为确保图表完整渲染，已禁用 HTML 标签模式，使用纯 SVG 渲染
